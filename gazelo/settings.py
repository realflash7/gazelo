"""
Django settings for gazelo project.
...
SECRET_KEY = '78cmfuf+_sidn^oo%*2(sm%k^**4ij^_-on1lh@f=+ed9k&mhy'
...
WSGI_APPLICATION = 'gazelo.wsgi.application'
